...
class PlaceCell: UICollectionViewCell {
        ...
        didSet {
            if let place = place {
                DispatchQueue.main.async {
                    ...
                    self.addressLabel.text = place.placemark.title
                }
            }
        }
    }
    ...
    private let addressLabel: UILabel = {
        ...
        lbl.text = ""
        lbl.textAlignment = .left
        lbl.font = UIFont(name: "AppleSDGothicNeo-Light", size: 15)
        return lbl
    }()
    ...
    override init(frame: CGRect) {
        ...
        addressLabel.bottomAnchor.constraint(equalTo: distanceLabel.topAnchor, constant: -2).isActive = true
        addressLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20).isActive = true
        addressLabel.trailingAnchor.constraint(equalTo: imageView.leadingAnchor, constant: -10).isActive = true
